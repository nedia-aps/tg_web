...
renderSpeedo(value){
  if(value === 0){
    return (<img src={require('../../images/0.png')} alt="background" style={{width: '100%'}}/>);
  } else if(value>0 && value<10){
    return (<img src={require('../../images/1.png')} alt="background" style={{width: '100%'}}/>);
  } else if(value>=10 && value<=20){
    return (<img src={require('../../images/2.png')} alt="background" style={{width: '100%'}}/>);
  } else if(value>=20 && value<=30){
    return (<img src={require('../../images/3.png')} alt="background" style={{width: '100%'}}/>);
  }else if(value>=30 && value<=40){
    return (<img src={require('../../images/4.png')} alt="background" style={{width: '100%'}}/>);
  }else if(value>=40 && value<=50){
    return (<img src={require('../../images/5.png')} alt="background" style={{width: '100%'}}/>);
  }else if(value>=50 && value<=60){
    return (<img src={require('../../images/6.png')} alt="background" style={{width: '100%'}}/>);
  }else if(value>=60 && value<=70){
    return (<img src={require('../../images/7.png')} alt="background" style={{width: '100%'}}/>);
  }else if(value>=70 && value<=80){
    return (<img src={require('../../images/8.png')} alt="background" style={{width: '100%'}}/>);
  }else if(value>=80 && value<=90){
    return (<img src={require('../../images/9.png')} alt="background" style={{width: '100%'}}/>);
  }else if(value>=90 && value<100){
    return (<img src={require('../../images/10.png')} alt="background" style={{width: '100%'}}/>);
  }
}
  render() {
